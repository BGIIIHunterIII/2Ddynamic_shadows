...
import main.java.Utils.FBO;
import main.java.Utils.Image;

import static main.java.Utils.Utils.createFbo;
import static main.java.Utils.Utils.createRasterProgram;
import static main.java.Utils.Utils.loadImage;
...
public class UniformArrayDemo {
  ...
  private void init() throws IOException {
    ...
    distortionProgram = createRasterProgram("res/shaderinos/distortion.vert","res/shaderinos/distortion.frag");
    inverseDistortionProgram = createRasterProgram("res/shaderinos/inversedistortion.vert","res/shaderinos/inversedistortion.frag");
    initPrograms();
    createFbo(distance,width,height);
    catImage = loadImage("res/images/cat4.png");
  }
  ...
  private void render() {
    ...
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, distance.fbo);
    ...
    //////////////////////////////////////////////
    //render to distance fbo
    glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, distortion.fbo);
    glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
